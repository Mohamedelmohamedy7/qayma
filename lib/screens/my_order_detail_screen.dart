                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Text(
                                ...
                                '${_orderStatus == "Processing"?"جاري التنفيذ":
                                _orderStatus == "Cancelled"?"تم الالغاء":_orderStatus=="Delivered"?"تم التوصيل":_orderStatus}',
                            style: GoogleFonts.tajawal(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            '${widget.myOrder.charges.orderAmt} ${Config().currency}',
                            style: GoogleFonts.tajawal(
                              color: Colors.black.withOpacity(0.8),
                              fontSize: 14.5,
                              fontWeight: FontWeight.w500,
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            '-${widget.myOrder.charges.discountAmt} ${Config().currency}',
                            style: GoogleFonts.tajawal(
                              color: Colors.black.withOpacity(0.8),
                              fontSize: 14.5,
                              fontWeight: FontWeight.w500,
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            '${widget.myOrder.charges.shippingAmt} ${Config().currency}',
                            style: GoogleFonts.tajawal(
                              color: Colors.black.withOpacity(0.8),
                              fontSize: 14.5,
                              fontWeight: FontWeight.w500,
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            '${widget.myOrder.charges.taxAmt} ${Config().currency}',
                            style: GoogleFonts.tajawal(
                              color: Colors.black.withOpacity(0.8),
                              fontSize: 14.5,
                              fontWeight: FontWeight.w500,
                              ...
                              children: [
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      '-${widget.myOrder.charges.couponDiscountAmt} ${Config().currency}',
                                      style: GoogleFonts.tajawal(
                                        color: Colors.black.withOpacity(0.8),
                                        fontSize: 14.5,
                                        fontWeight: FontWeight.w500,
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            '${widget.myOrder.charges.totalAmt} ${Config().currency}',
                            style: GoogleFonts.tajawal(
                              color: Colors.black.withOpacity(0.8),
                              fontSize: 14.5,
                              fontWeight: FontWeight.w600,
